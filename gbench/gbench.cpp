...
BENCHMARK(BM_FtVectorConstructorWithSize)->Range(1, 1 << 22);
...
BENCHMARK(BM_StdVectorConstructorWithSize)->Range(1, 1 << 22);
...
BENCHMARK(BM_FtVectorConstructorWithSizeAndValue)->Range(1, 1 << 22);
...
BENCHMARK(BM_StdVectorConstructorWithSizeAndValue)->Range(1, 1 << 22);
...
BENCHMARK(BM_FtVectorClear)->Range(1, 1 << 22);
...
BENCHMARK(BM_FtVectorInsert)->Range(1, 1 << 22);
...
BENCHMARK(BM_StdVectorInsert)->Range(1, 1 << 22);
...
BENCHMARK(BM_FtVectorAssign)->Range(1, 1 << 22);
...
BENCHMARK(BM_StdVectorAssign)->Range(1, 1 << 22);
