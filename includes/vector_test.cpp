...
int main() {
  ...
  // std::cout << "========== ft_v.insert(ft_v.begin(), 1) ===========" << std::endl;
  // ft::vector<int>::iterator it = ft_v.erase(ft_v.begin());
  // std::cout << *it << std::endl;
  // ft_v.insert(ft_v.begin(), 1);
  // std::cout << "ft_v.insert(ft_v.begin(), 1)" << std::endl;
  // ft_v.insert(ft_v.begin(), 2);
  // std::cout << "ft_v.insert(ft_v.begin(), 2)" << std::endl;
  // ft_v.insert(ft_v.begin(), 3);
  // std::cout << "ft_v.insert(ft_v.begin(), 3)" << std::endl;
  // ft_v.insert(ft_v.begin(), 4);
  // std::cout << "ft_v.insert(ft_v.begin(), 4)" << std::endl;
  // for (size_t i = 0; i < ft_v.size(); ++i) std::cout << ft_v[i] << " ";
  // std::cout << std::endl;
